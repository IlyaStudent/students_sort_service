...
class EvenOddQuickSortTest {

    private EvenOddQuickSort evenOddQuickSort;

    @BeforeEach
    void setUp() {
        evenOddQuickSort = new EvenOddQuickSort();
    }
    ...
    void sort_ShouldThrowException_WhenComparatorIsNull() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
                evenOddQuickSort.sort(list, null)
        );
    }
    ...
    void sort_ShouldThrowException_WhenListContainsNonStudentObjects() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
                evenOddQuickSort.sort(list, Comparator.naturalOrder())
        );
    }
    ...
    void sort_ShouldHandleEmptyList() {
        ...
        assertDoesNotThrow(() -> evenOddQuickSort.sort(list, comparator));
    ...
    void sort_ShouldHandleSingleElement() {
        ...
        evenOddQuickSort.sort(list, comparator);
    ...
    void sort_ShouldSortOnlyStudentsWithEvenAverageScore() {
        ...
        evenOddQuickSort.sort(students, Comparator.comparing(Student::getGroupNumber));
    ...
    void sort_ShouldSortByAverageScore_OnlyEvenStudents() {
        ...
        evenOddQuickSort.sort(students, Comparator.comparingDouble(Student::getAverageScore));
    ...
    void sort_ShouldSortDescending_OnlyEvenStudents() {
        ...
        evenOddQuickSort.sort(students, Comparator.comparingDouble(Student::getAverageScore).reversed());
    ...
    void sort_ShouldHandleComplexScenario() {
        ...
        evenOddQuickSort.sort(students, Comparator.naturalOrder());
