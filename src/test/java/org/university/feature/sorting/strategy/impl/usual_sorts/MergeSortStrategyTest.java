...
class MergeSortStrategyTest {
    ...
    private MergeSortStrategy mergeSort;
    ...
    @Test
    void getName_ShouldReturnMergeSortName() {
        assertEquals("Сортировка слиянием", mergeSort.getName());
    }
    ...
    void sort_ShouldHandleEmptyList() {
        ...
        assertDoesNotThrow(() -> mergeSort.sort(list, comparator));
    ...
    void sort_ShouldSortIntegersDescending() {
        ...
        mergeSort.sort(list, Comparator.reverseOrder());
    ...
    void sort_ShouldSortStudentsNaturally() {
        ...
        mergeSort.sort(students, Comparator.naturalOrder());
