...
class EvenOddBubbleSortTest {

    private EvenOddBubbleSort evenOddBubbleSort;

    @BeforeEach
    void setUp() {
        evenOddBubbleSort = new EvenOddBubbleSort();
    }
    ...
    void sort_ShouldThrowException_WhenComparatorIsNull() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
                evenOddBubbleSort.sort(list, null)
        );
    }
    ...
    void sort_ShouldThrowException_WhenListContainsNonStudentObjects() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
                evenOddBubbleSort.sort(list, Comparator.naturalOrder())
        );
    }
    ...
    void sort_ShouldHandleEmptyList() {
        ...
        assertDoesNotThrow(() -> evenOddBubbleSort.sort(list, comparator));
    ...
    void sort_ShouldHandleSingleElement() {
        ...
        evenOddBubbleSort.sort(list, comparator);
    ...
    void sort_ShouldSortOnlyStudentsWithEvenAverageScore() {
        ...
        evenOddBubbleSort.sort(students, Comparator.comparing(Student::getGroupNumber));
    ...
    void sort_ShouldSortByAverageScore_OnlyEvenStudents() {
        ...
        evenOddBubbleSort.sort(students, Comparator.comparingDouble(Student::getAverageScore));
    ...
    void sort_ShouldSortDescending_OnlyEvenStudents() {
        ...
        evenOddBubbleSort.sort(students, Comparator.comparingDouble(Student::getAverageScore).reversed());
    ...
    void sort_ShouldHandleComplexScenario() {
        ...
        evenOddBubbleSort.sort(students, Comparator.naturalOrder());
